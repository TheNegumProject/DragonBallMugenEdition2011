...
type = ChangeState
value = 2200
triggerall = command = "BurningAttack" && command != "holddown" && power >= 2000 && var(1) != 0
trigger1 = statetype = S && ctrl
trigger2 = stateno = 3100
;===========================================================================
...
type = ChangeState
value = 1700
triggerall = (var(1) = 0 && power < 3000 && time > 2) || (var(1) != 0 && power < 3000 && time > 2)
...
type = ChangeState
value = 1300
triggerall = (command = "QCF_a" || command = "QCF_b" || command = "QCF_c") && command != "holddown" && !(Var(1) = 1 && power = 0)
trigger1 = statetype = A && ctrl
trigger2 = (stateno = [600,660]) && movecontact
trigger3 = stateno = 3100
;---------------------------------------------------------------------------
